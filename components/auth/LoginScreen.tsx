      ...
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: 11, color: 'rgba(255,255,255,0.6)', marginTop: 5, marginBottom: 0, textTransform: 'uppercase', letterSpacing: '0.08em', fontWeight: 500 }}>
          ...
          <div style={{ padding: '28px 32px 32px' }}>
            <p style={{ fontSize: 13, color: TOKENS.muted, marginTop: 0, marginBottom: 22, textAlign: 'center' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 11, color: TOKENS.muted, marginTop: 20, opacity: 0.7 }}>
